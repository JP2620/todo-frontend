...
function SignUpView() {
  ...
  const [lastModificationUsername, setLastModificationUsername] = useState(
    Date.now() / 1000
  );

  const navigate = useNavigate();
  const URL = "http://localhost:5001/api/users/create";
      ...
      >
        ...
        <div className="form-field">
          ...
          <input
            ...
            style={{
              backgroundColor: usernameAvailable ? "inherit" : "#f0b9c8",
              borderWidth: "1px",
            }}
            minLength={3}
            required
